...
**SEP-IRA:** Up to 25% of net self-employment income, maximum $69,000 for 2024 (adjusted annually). Contributions are fully deductible from AGI.

**Solo 401(k):** Two components — employee contribution (up to $23,000 in 2024, or $30,500 if 50+) + employer contribution (up to 25% of net SE income). Total cap same as SEP-IRA but the employee contribution is higher, making Solo 401k often better for higher earners.
...
**Mileage:** If you drive for business (client visits, not commuting), deduct using the standard mileage rate: **$0.67/mile** in 2024 (rate adjusts annually). Track with an app like MileIQ.
