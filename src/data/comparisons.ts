...
export const comparisons: Comparison[] = [
  ...
  },
  {
    ...
    rows: [
      { feature: "Starting monthly price",    a: "$25/mo (Essentials)", b: "$19/mo",       winner: "b" },
