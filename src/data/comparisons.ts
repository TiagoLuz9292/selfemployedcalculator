...
export const comparisons: Comparison[] = [
  {
    ...
    faqs: [
      ...
      { question: "How much does FreshBooks cost per month?", answer: "FreshBooks starts at $19/month (Lite plan, 5 clients). The Plus plan at $33/month removes the client limit. Pricing is for one user — additional team members cost extra. FreshBooks frequently offers 50-70% off for the first 6 months." },
    ...
    rows: [
      { feature: "Starting monthly price",       a: "$19/mo (Lite)",    b: "$20/mo",              winner: "a" },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Is Bonsai worth it for freelancers?", answer: "Bonsai is worth it if you spend significant time on client onboarding (proposals, contracts) and want it in the same tool as invoicing. At $21/month versus FreshBooks Lite at $19/month, the small price difference is easily justified by Bonsai's built-in contract templates and e-signing, which would otherwise require a separate DocuSign or HelloSign subscription. It's particularly popular with designers, writers, and consultants." },
    ...
    rows: [
      { feature: "Starting monthly price",    a: "$21/mo",           b: "$19/mo",          winner: "b" },
  ...
  // ─── FRESHBOOKS VS WAVE ────────────────────────────────────────────────────
  {
    ...
    rows: [
      { feature: "Monthly cost",              a: "$19/mo (Lite)",        b: "Free (Pro: ~$16/mo)",    winner: "b" },
  ...
  // ─── TOGGL VS HARVEST ──────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: "Which is better for freelancers, Toggl or Harvest?", answer: "If you already use FreshBooks or Bonsai for invoicing, Toggl Track is better — it's free, has a cleaner interface, and integrates with your existing invoicing tool. If you want to consolidate time tracking and invoicing into one tool and are willing to pay $12/month, Harvest is the better choice. Note that Harvest removed its free plan in 2023, so it's $12/month from day one. Harvest is particularly useful for client-facing billing where you want to show clients exactly what hours you're charging for." },
    ...
    rows: [
      { feature: "Free plan",                   a: "Yes (unlimited tracking)", b: "No (free plan removed 2023)", winner: "a" },
    ...
    verdict: "If you already use FreshBooks, Bonsai, or another invoicing tool, Toggl Track is the better time tracker — cleaner interface, excellent mobile app, and a genuinely useful free plan with unlimited projects and clients. If you want to simplify your stack and invoice clients directly from tracked time without a separate app, Harvest is the better all-in-one choice at $12/month (Harvest removed its free plan in 2023). The Harvest + Harvest Forecast combination is particularly useful for freelancers managing multiple clients who want to visualise their schedule weeks ahead. Solo freelancers just starting out: Toggl's free plan is the clear choice — track unlimited time at zero cost, then decide if you need Harvest's invoicing once you have consistent clients.",
  },
];
